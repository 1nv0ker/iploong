        ...
        <ModalCompoent v-model="open" :title="$t('usercenter.pay.button1')" slotMode :width="424">
            <div class="w-full">
                ...
                <div class="pt-[60px] flex justify-center items-center flex-col gap-[8px]">
                    <a-button :loading="loading" class="w-[324px] h-[50px!important] border-1 border-[#666666!important] rounded-[10px!important] cursor-pointer flex justify-center items-center" @click="onConfirm">
                        <span class="text-[#666666] text-[17px] poppins_font">{{$t('usercenter.pay.button3')}}</span>
