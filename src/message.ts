export const zh = {
    ...
    usercenter: {
        ...
        realauth: {
            ...
            title3:'技术认证',
            tiptitle:'小贴士',
            content:'1、同 1 个身份信息可实名最多 1 个账号\n2、企业账户请避免使用个人实名，以免企业人员变动或交接引起不必要的纠纷\n3、完成实名认证后，免费试用额度立即到账，可用于使用动态住宅、长效ISP。',
            more:'了解更多',
            personal: {
                title1:'填写基本信息',
                title2:'校验认证',
...
export const en = {
    ...
    home: {
        first: {
            title:'Provide you with the most professional',
            title2:'Global IP',
            title3:'Solution',
    ...
    usercenter: {
        ...
        pay: {
            ...
            button2:'Alipay payment',
            pay1:'Alipay',
            pay2:'WeChat',
            button3:'WeChat payment',
        ...
        realauth: {
            title1:'Personal certification',
            title2:'Enterprise Certification',
            title3:'Technology Certification',
            tiptitle:'Tips',
            content:`1. The same identity information can be used to register at most 1 account\n2. Please avoid using personal real names for corporate accounts to avoid unnecessary disputes caused by changes or handovers of corporate personnel\n3. After completing the real-name authentication, the free trial quota will be credited immediately and can be used to use dynamic residences and long-term ISPs.`,
            more:'learn more',
            personal: {
                title1:'Fill in basic information',
                title2:'Verification and certification',
                title3:'Certification completed, free trial',
                subtitle1:'Information Authentication',
                form1:'Real name',
                content1:"Please enter your real name",
                form2:'ID number',
                content2:'Please enter your ID number',
                form3:'Usage scenarios',
                content3:'Please select your usage scenario',
                form4:'Proxy Type',
                content4:'Please select the proxy type',
                form5:'Country of Use',
                content5:'Please enter the country',
                button:'submit',
                subtitle2:'Verification and certification',
                button2:'Alipay scan code authentication',
                button3:'WeChat authentication',
                subtitle3:'Certification completed, free trial',
                button4:'Confirm'
            }
        },
        promotion: {
